...
cp obj/local/armeabi/libMeshMLLib.a ../../lib/android_armeabi/

if [ ! -d ../../lib/android_armeabi-v7a ]; then
	mkdir ../../lib/android_armeabi-v7a
fi
cp obj/local/armeabi-v7a/libMeshMLLib.a ../../lib/android_armeabi-v7a/

if [ ! -d ../../lib/android_x86 ]; then
	mkdir ../../lib/android_x86
fi
cp obj/local/x86/libMeshMLLib.a ../../lib/android_x86/
