	...
	public:
			...
			: RenderableHelper(L"Polygon")
		{
			...
			*(technique_->Effect().ParameterByName("distance_tex")) = dist_loader();
			...
			rl_->BindVertexStream(tex0_vb, make_tuple(vertex_element(VEU_TextureCoord, 0, EF_GR32F)));
			...
			rl_->BindVertexStream(tan_vb, make_tuple(vertex_element(VEU_Tangent, 0, fmt)));
