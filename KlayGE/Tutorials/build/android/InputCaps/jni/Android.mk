...
INPUTCAPS_PATH := $(LOCAL_PATH)
INPUTCAPS_SRC_PATH := $(LOCAL_PATH)/../../../../src/InputCaps

include $(CLEAR_VARS)

LOCAL_C_INCLUDES := $(INPUTCAPS_SRC_PATH)/../../../../External/boost \
		$(INPUTCAPS_SRC_PATH)/../../../../KFL/include \
		$(INPUTCAPS_SRC_PATH)/../../../Core/Include \
		
LOCAL_MODULE := InputCaps
LOCAL_PATH := $(INPUTCAPS_SRC_PATH)
CPP_FILE_LIST := $(wildcard $(LOCAL_PATH)/*.cpp)
LOCAL_SRC_FILES := $(CPP_FILE_LIST:$(LOCAL_PATH)/%=%)
LOCAL_LDLIBS := -llog -landroid
LOCAL_STATIC_LIBRARIES := KlayGE_Core KlayGE_Render_OpenGLES KlayGE_Scene_OCTree KlayGE_Input_MsgInput KFL glloader kfont MeshMLLib \
