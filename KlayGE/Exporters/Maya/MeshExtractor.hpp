...
namespace KlayGE
{
    ...
    public:
        ...
        {
        public:
            TemplatePoint() { Set(NULL); }
            TemplatePoint(const Type* ptr) { Set(ptr); }
            ...
            TemplatePoint& operator=( const TemplatePoint& rhs )
            {
            ...
            bool operator==( const TemplatePoint& rhs ) const
            {
                bool is_same = true;
                for (size_t i=0; i<Size; ++i)
                {
    ...
    public:
        ...
        struct MaterialStruct
        {
            ...
            bool operator==( const MaterialStruct& rhs ) const
            {
        ...
        struct TriangleStruct
        {
            ...
            bool operator==( const TriangleStruct& rhs ) const
            {
    ...
    public:
        ...
        void StartFrame(int sf) { start_frame_ = sf; }
        int StartFrame() const { return start_frame_; }
        
        void EndFrame(int ef) { end_frame_ = ef; }
        int EndFrame() const { return end_frame_; }
        
        void FrameRate(int fr) { frame_rate_ = fr; }
        ...
        void VertexExportSettings(int ves) { vertexExportSettings_ = ves; }
        int VertexExportSettings() const { return vertexExportSettings_; }
        ...
        void UserExportSettings(int ues) { userExportSettings_ = ues; }
        int UserExportSettings() const { return userExportSettings_; }
        
        void Output(std::ostream* out) { output_stream_ = out; }
        std::ostream* Output() { return output_stream_; }
        
        void AddJoint( const std::string& name, const JointStruct& joint ) { joints_[name] = joint; }
        void AddMaterial( const MaterialStruct& material ) { obj_materials_.push_back(material); }
        void AddMesh( const MeshStruct& mesh ) { obj_meshes_.push_back(mesh); }
        void AddKeyframe( const KeyframeStruct& kf ) { keyframes_.push_back(kf); }
        
        virtual void OptimizeData();
        virtual void WriteMeshML(int modelVersion, const std::string& encoding=std::string());
