...
namespace KlayGE
{
	VertexStream::VertexStream(VertexStreamType type, U8 sizeElement, U8 ElementsPerVertex)
			: type_(type),
	...
	void RenderBuffer::AddVertexStream(VertexStreamType type, U8 sizeElement, U8 numElement, bool staticStream)
	{
