...
DEFINE_UUID_OF(ID3D11Device1);
DEFINE_UUID_OF(ID3D11Device2);
DEFINE_UUID_OF(ID3D11Device3);
DEFINE_UUID_OF(ID3D11Device4);
DEFINE_UUID_OF(ID3D11Device5);
DEFINE_UUID_OF(ID3D11DeviceContext1);
DEFINE_UUID_OF(ID3D11DeviceContext2);
DEFINE_UUID_OF(ID3D11DeviceContext3);
DEFINE_UUID_OF(ID3D11DeviceContext4);
DEFINE_UUID_OF(ID3D11Fence);
