...
namespace KlayGE
{
	...
	void OGLESTexture2D::CopyToTexture(Texture& target, TextureFilter filter)
	{
	...
	void OGLESTexture2D::CopyToSubTexture2D(Texture& target, uint32_t dst_array_index, uint32_t dst_level, uint32_t dst_x_offset,
