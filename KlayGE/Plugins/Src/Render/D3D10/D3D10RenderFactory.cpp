...
namespace KlayGE
{
	...
	TexturePtr D3D10RenderFactory::MakeTexture1D(uint32_t width, uint32_t numMipMaps, uint32_t array_size,
			ElementFormat format, uint32_t sample_count, uint32_t sample_quality, uint32_t access_hint, ElementInitData* init_data)
	{
		return MakeSharedPtr<D3D10Texture1D>(width, numMipMaps, array_size, format, sample_count, sample_quality, access_hint, init_data);
	}
	TexturePtr D3D10RenderFactory::MakeTexture2D(uint32_t width, uint32_t height, uint32_t numMipMaps, uint32_t array_size,
			ElementFormat format, uint32_t sample_count, uint32_t sample_quality, uint32_t access_hint, ElementInitData* init_data)
	{
		return MakeSharedPtr<D3D10Texture2D>(width, height, numMipMaps, array_size, format, sample_count, sample_quality, access_hint, init_data);
	}
	TexturePtr D3D10RenderFactory::MakeTexture3D(uint32_t width, uint32_t height, uint32_t depth, uint32_t numMipMaps, uint32_t array_size,
			ElementFormat format, uint32_t sample_count, uint32_t sample_quality, uint32_t access_hint, ElementInitData* init_data)
	{
		return MakeSharedPtr<D3D10Texture3D>(width, height, depth, numMipMaps, array_size, format, sample_count, sample_quality, access_hint, init_data);
	}
	TexturePtr D3D10RenderFactory::MakeTextureCube(uint32_t size, uint32_t numMipMaps, uint32_t array_size,
			ElementFormat format, uint32_t sample_count, uint32_t sample_quality, uint32_t access_hint, ElementInitData* init_data)
	{
		return MakeSharedPtr<D3D10TextureCube>(size, numMipMaps, array_size, format, sample_count, sample_quality, access_hint, init_data);
	}
	...
	GraphicsBufferPtr D3D10RenderFactory::MakeVertexBuffer(BufferUsage usage, uint32_t access_hint, ElementInitData* init_data, ElementFormat fmt)
	{
		return MakeSharedPtr<D3D10GraphicsBuffer>(usage, access_hint, D3D10_BIND_VERTEX_BUFFER, init_data, fmt);
	}

	GraphicsBufferPtr D3D10RenderFactory::MakeIndexBuffer(BufferUsage usage, uint32_t access_hint, ElementInitData* init_data, ElementFormat fmt)
	{
		return MakeSharedPtr<D3D10GraphicsBuffer>(usage, access_hint, D3D10_BIND_INDEX_BUFFER, init_data, fmt);
	}
	...
	RenderViewPtr D3D10RenderFactory::Make1DRenderView(Texture& texture, int array_index, int level)
	{
		return MakeSharedPtr<D3D10RenderTargetRenderView>(texture, array_index, level);
	}

	RenderViewPtr D3D10RenderFactory::Make2DRenderView(Texture& texture, int array_index, int level)
	{
		return MakeSharedPtr<D3D10RenderTargetRenderView>(texture, array_index, level);
	}

	RenderViewPtr D3D10RenderFactory::Make2DRenderView(Texture& texture, int array_index, Texture::CubeFaces face, int level)
	{
