...
namespace KlayGE
{
	...
	D3D10RenderEngine::D3D10RenderEngine()
	{
		...
		if (NULL == mod_d3d10_)
		{
			::MessageBoxW(NULL, L"Can't load d3d10.dll", L"Error", MB_OK);
		}
	...
	void D3D10RenderEngine::DoDispatch(RenderTechnique const & /*tech*/, uint32_t /*tgx*/, uint32_t /*tgy*/, uint32_t /*tgz*/)
	{
		BOOST_ASSERT(false);
	}
