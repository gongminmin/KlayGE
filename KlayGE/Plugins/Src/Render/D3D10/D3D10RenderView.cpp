...
namespace KlayGE
{
	...
	D3D10RenderTargetRenderView::D3D10RenderTargetRenderView(Texture& texture_1d_2d, int level)
	{
	...
	D3D10RenderTargetRenderView::D3D10RenderTargetRenderView(Texture& texture_3d, uint32_t slice, int level)
	{
	...
	D3D10RenderTargetRenderView::D3D10RenderTargetRenderView(Texture& texture_cube, Texture::CubeFaces face, int level)
	{
