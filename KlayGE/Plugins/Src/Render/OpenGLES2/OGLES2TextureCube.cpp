...
namespace KlayGE
{
	...
	void OGLES2TextureCube::CopyToSubTextureCube(Texture& target,
	...
	void OGLES2TextureCube::MapCube(uint32_t array_index, CubeFaces face, uint32_t level, TextureMapAccess tma,
