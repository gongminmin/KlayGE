...
namespace KlayGE
{
	...
	void OGLTexture::CopyToTextureArray(Texture& /*target*/, int /*array_index*/, int /*level*/,
			uint32_t /*dst_width*/, uint32_t /*dst_height*/, uint32_t /*dst_xOffset*/, uint32_t /*dst_yOffset*/,
			uint32_t /*src_width*/, uint32_t /*src_height*/, uint32_t /*src_xOffset*/, uint32_t /*src_yOffset*/)
	{
		BOOST_ASSERT(false);
	...
	void OGLTexture::Map1D(int /*array_index*/, int /*level*/, TextureMapAccess /*tma*/,
		uint32_t /*x_offset*/, uint32_t /*width*/, void*& /*data*/)
	{
		BOOST_ASSERT(false);
	}

	void OGLTexture::Map2D(int /*array_index*/, int /*level*/, TextureMapAccess /*tma*/,
	...
	void OGLTexture::Map3D(int /*array_index*/, int /*level*/, TextureMapAccess /*tma*/,
	...
	void OGLTexture::MapCube(int /*array_index*/, CubeFaces /*face*/, int /*level*/, TextureMapAccess /*tma*/,
	...
	void OGLTexture::Unmap1D(int /*array_index*/, int /*level*/)
	{
		BOOST_ASSERT(false);
	}

	void OGLTexture::Unmap2D(int /*array_index*/, int /*level*/)
	{
		BOOST_ASSERT(false);
	}

	void OGLTexture::Unmap3D(int /*array_index*/, int /*level*/)
	{
		BOOST_ASSERT(false);
	}

	void OGLTexture::UnmapCube(int /*array_index*/, CubeFaces /*face*/, int /*level*/)
	{
		BOOST_ASSERT(false);
	}
