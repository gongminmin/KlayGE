...
int main(int argc, char* argv[])
{
	...
	else
	{
		...
		TexturePtr vol_map_texture = render_factory.MakeTexture3D(width, height, depth, 1, EF_R8, 1, 0, EAH_CPU_Read | EAH_CPU_Write, NULL);
	...
	TexturePtr distance_map_texture = render_factory.MakeTexture3D(width, height, depth, 1, EF_R8, 1, 0, EAH_CPU_Read | EAH_CPU_Write, NULL);
