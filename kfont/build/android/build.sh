...
cp obj/local/armeabi/libkfont.a ../../lib/android_armeabi/

if [ ! -d ../../lib/android_armeabi-v7a ]; then
	mkdir ../../lib/android_armeabi-v7a
fi
cp obj/local/armeabi-v7a/libkfont.a ../../lib/android_armeabi-v7a/

if [ ! -d ../../lib/android_x86 ]; then
	mkdir ../../lib/android_x86
fi
cp obj/local/x86/libkfont.a ../../lib/android_x86/
