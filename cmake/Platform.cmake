IF(WIN32)
	...
	IF(WINRT)
		SET(KLAYGE_BUILD_PLATFORM_WINDOWS_STORE TRUE)
		SET(KLAYGE_BUILD_PLATFORM_WINDOWS_RUNTIME TRUE)
	ELSE()
		SET(KLAYGE_BUILD_PLATFORM_WINDOWS_DESKTOP TRUE)
	ENDIF()
ELSEIF(ANDROID)
...
IF(KLAYGE_BUILD_PLATFORM_WINDOWS_STORE)
