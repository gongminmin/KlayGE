...
IF(MSVC)
	SET(CMAKE_CXX_FLAGS "/DWIN32 /D_WINDOWS /W4 /WX /EHsc")
	SET(CMAKE_EXE_LINKER_FLAGS "/WX /pdbcompress /INCREMENTAL:NO")
	SET(CMAKE_SHARED_LINKER_FLAGS "/WX /pdbcompress /INCREMENTAL:NO")
	SET(CMAKE_MODULE_LINKER_FLAGS "/WX /pdbcompress /INCREMENTAL:NO")
	...
	SET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /fp:fast /DKLAYGE_SHIP /Ob2 /GL")
	SET(CMAKE_CXX_FLAGS_RELWITHDEBINFO "${CMAKE_CXX_FLAGS_RELWITHDEBINFO} /fp:fast /Ob2 /GL")
...
ELSE()
	...
	IF(KLAYGE_ARCH_NAME STREQUAL "x86")
		...
		IF(KLAYGE_PLATFORM_WINDOWS)
			...
			SET(CMAKE_STATIC_LINKER_FLAGS "${CMAKE_STATIC_LINKER_FLAGS} -Wl,--large-address-aware")
