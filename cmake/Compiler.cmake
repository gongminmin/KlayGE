...
IF(MSVC)
	...
	IF(KLAYGE_PLATFORM_WINDOWS_PHONE)
		SET(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /NODEFAULTLIB:Advapi32.lib;Psapi.lib;kernel32.lib;ole32.lib;%(IgnoreSpecificDefaultLibraries)")
		SET(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /NODEFAULTLIB:Advapi32.lib;Psapi.lib;kernel32.lib;ole32.lib;%(IgnoreSpecificDefaultLibraries)")
	ENDIF()
