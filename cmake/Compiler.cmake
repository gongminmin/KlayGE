...
ELSE()
	...
	FUNCTION(CREATE_XCODE_USERFILE TARGETNAME)
		IF(KLAYGE_PLATFORM_DARWIN)
			...
			CONFIGURE_FILE(
				...
				${PROJECT_BINARY_DIR}/Samples.xcodeproj/xcuserdata/${USER_NAME}.xcuserdatad/xcschemes/${TARGETNAME}.xcscheme
				@ONLY
			)
		ENDIF()
	ENDFUNCTION()
...
FUNCTION(CREATE_PROJECT_USERFILE TARGETNAME)
	IF(MSVC)
		CREATE_VCPROJ_USERFILE(${TARGETNAME})
	ELSEIF(KLAYGE_PLATFORM_DARWIN)
		CREATE_XCODE_USERFILE(${TARGETNAME})
	ENDIF()
ENDFUNCTION()
