...
FUNCTION(GEN_FILE_ID_NAME RELATIVE_PATH FILE_ID_NAME)
	STRING(REPLACE / _ REL_ID ${RELATIVE_PATH})
	STRING(REPLACE . _ REL_ID ${REL_ID})
	SET(${FILE_ID_NAME} ${REL_ID}_FILE_ID PARENT_SCOPE)
ENDFUNCTION()

FUNCTION(DOWNLOAD_FILE RELATIVE_PATH COMMIT)
	GEN_FILE_ID_NAME(${RELATIVE_PATH} REL_FILE_ID_NAME)
	SET(DEST ${KLAYGE_ROOT_DIR}/${RELATIVE_PATH})
	IF(NOT ((EXISTS ${DEST}) AND ("${${REL_FILE_ID_NAME}}" STREQUAL ${COMMIT})))
		SET(URL "https://raw.githubusercontent.com/gongminmin/KlayGEDependencies/${COMMIT}/${RELATIVE_PATH}")
		...
		ELSE()
			SET(${REL_FILE_ID_NAME} ${COMMIT} CACHE INTERNAL "" FORCE)
		ENDIF()
	ENDIF()
ENDFUNCTION()
