...
namespace KlayGE
{
	...
	public:
		...
		KLAYGE_DEFAULT_ADD_OPERATOR1(half);
		KLAYGE_DEFAULT_SUB_OPERATOR1(half);
		KLAYGE_DEFAULT_MUL_OPERATOR1(half);
		KLAYGE_DEFAULT_DIV_OPERATOR1(half);

		KLAYGE_DEFAULT_EQUALITY_COMPARE_OPERATOR(half);
