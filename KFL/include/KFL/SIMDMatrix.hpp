...
namespace KlayGE
{
	...
	public:
		...
		KLAYGE_DEFAULT_ADD_OPERATOR1(SIMDMatrixF4);
		KLAYGE_DEFAULT_SUB_OPERATOR1(SIMDMatrixF4);

		KLAYGE_DEFAULT_MUL_OPERATOR1(SIMDMatrixF4);
		KLAYGE_DEFAULT_MUL_OPERATOR2(SIMDMatrixF4, float);
		KLAYGE_DEFAULT_MUL_OPERATOR3(float, SIMDMatrixF4);

		KLAYGE_DEFAULT_DIV_OPERATOR2(SIMDMatrixF4, float);
