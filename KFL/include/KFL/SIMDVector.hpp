...
namespace KlayGE
{
	...
	public:
		...
		KLAYGE_DEFAULT_ADD_OPERATOR1(SIMDVectorF4);
		KLAYGE_DEFAULT_ADD_OPERATOR2(SIMDVectorF4, float);
		KLAYGE_DEFAULT_ADD_OPERATOR3(float, SIMDVectorF4);

		KLAYGE_DEFAULT_SUB_OPERATOR1(SIMDVectorF4);
		KLAYGE_DEFAULT_SUB_OPERATOR2(SIMDVectorF4, float);

		KLAYGE_DEFAULT_MUL_OPERATOR1(SIMDVectorF4);
		KLAYGE_DEFAULT_MUL_OPERATOR2(SIMDVectorF4, float);
		KLAYGE_DEFAULT_MUL_OPERATOR3(float, SIMDVectorF4);

		KLAYGE_DEFAULT_DIV_OPERATOR1(SIMDVectorF4);
		KLAYGE_DEFAULT_DIV_OPERATOR2(SIMDVectorF4, float);
