...
namespace KlayGE
{
	...
	public:
		...
		KLAYGE_DEFAULT_ADD_OPERATOR1(Color_T<T>);
		KLAYGE_DEFAULT_SUB_OPERATOR1(Color_T<T>);
		KLAYGE_DEFAULT_MUL_OPERATOR1(Color_T<T>);
		KLAYGE_DEFAULT_MUL_OPERATOR2(Color_T<T>, T);
		KLAYGE_DEFAULT_MUL_OPERATOR3(T, Color_T<T>);
		KLAYGE_DEFAULT_DIV_OPERATOR2(Color_T<T>, T);

		KLAYGE_DEFAULT_EQUALITY_COMPARE_OPERATOR(Color_T<T>);
