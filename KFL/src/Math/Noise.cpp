...
namespace KlayGE
{
	namespace MathLib
	{
		template SimplexNoise<float>::SimplexNoise();
		template SimplexNoise<float>& SimplexNoise<float>::Instance();
		template float SimplexNoise<float>::noise(float x, float y);
		template float SimplexNoise<float>::noise(float x, float y, float z);
		template float SimplexNoise<float>::fBm(float x, float y, int octaves, float lacunarity, float gain);
		template float SimplexNoise<float>::fBm(float x, float y, float z, int octaves, float lacunarity, float gain);
		template float SimplexNoise<float>::turbulence(float x, float y, int octaves, float lacunarity, float gain);
		template float SimplexNoise<float>::turbulence(float x, float y, float z, int octaves, float lacunarity, float gain);
		...
		template float SimplexNoise<float>::tileable_turbulence(float x, float y,
				float w, float h, int octaves, float lacunarity, float gain);
		template float SimplexNoise<float>::tileable_turbulence(float x, float y, float z,
				float w, float h, float d, int octaves, float lacunarity, float gain);
		...
		template <typename T>
		T SimplexNoise<T>::noise(T x, T y)
		{
		...
		template <typename T>
		T SimplexNoise<T>::noise(T x, T y, T z)
		{
			T const F3 = 1 / T(3);
			T const G3 = 1 / T(6);
		...
		template <typename T>
		T SimplexNoise<T>::fBm(T x, T y, int octaves, T lacunarity, T gain)
		{
			T sum = 0;
			T amp = 1;
			T amp_sum = 0;
		...
		template <typename T>
		T SimplexNoise<T>::fBm(T x, T y, T z, int octaves, T lacunarity, T gain)
		{
			T sum = 0;
			T amp = 1;
			T amp_sum = 0;
		...
		template <typename T>
		T SimplexNoise<T>::turbulence(T x, T y, int octaves, T lacunarity, T gain)
		{
			T sum = 0;
			T amp = 1;
			T amp_sum = 0;
		...
		template <typename T>
		T SimplexNoise<T>::turbulence(T x, T y, T z, int octaves, T lacunarity, T gain)
		{
			T sum = 0;
			T amp = 1;
			T amp_sum = 0;
		...
		template <typename T>
		T SimplexNoise<T>::tileable_noise(T x, T y, T w, T h)
		{
		...
		template <typename T>
		T SimplexNoise<T>::tileable_noise(T x, T y, T z, T w, T h, T d)
		{
		...
		T SimplexNoise<T>::tileable_turbulence(T x, T y,
			T w, T h, int octaves, T lacunarity, T gain)
		{
			T sum = 0;
			T amp = 1;
			T amp_sum = 0;
		...
		T SimplexNoise<T>::tileable_turbulence(T x, T y, T z,
			T w, T h, T d, int octaves, T lacunarity, T gain)
		{
			T sum = 0;
			T amp = 1;
			T amp_sum = 0;
