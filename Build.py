...
if __name__ == "__main__":
	...
	for compiler_info in build_info.compilers:
		if (not build_info.is_clean) and compiler_info.is_cross_compiling and (len(build_info.host_bin_dir) == 0):
			...
			BuildProjects("KlayGE", ".", host_build_info, host_build_info.compilers[0], ("KlayGE/Tools/FXMLJIT/FXMLJIT", "KlayGE/Tools/MeshConv/MeshConv", "KlayGE/Tools/ImageConv/ImageConv"), additional_options)
