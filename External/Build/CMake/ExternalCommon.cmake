...
FUNCTION(DOWNLOAD_PACKAGE PACKAGE_NAME RELATIVE_PATH FILE_ID)
	DOWNLOAD_7Z()
	DOWNLOAD_DEPENDENCY(${RELATIVE_PATH} ${FILE_ID} FILE_CHANGED)

	SET(CACHED_FILE_ID_NAME "HASH_${PACKAGE_NAME}")
	STRING(REPLACE "/" "_" ${CACHED_FILE_ID_NAME} "${${CACHED_FILE_ID_NAME}}")
	IF(FILE_CHANGED OR (NOT ("${${CACHED_FILE_ID_NAME}}" STREQUAL "${FILE_ID}")))
		...
		SET(${CACHED_FILE_ID_NAME} "${FILE_ID}" CACHE INTERNAL "Hash of ${PACKAGE_NAME}" FORCE)
	ENDIF()
ENDFUNCTION()

function(UpdateExternalLib name relative_path url rev)
	set(need_checkout FALSE)
	set(external_folder "${KLAYGE_ROOT_DIR}/External/${relative_path}")
	...
	if(need_checkout)
		...
		execute_process(COMMAND "git" "checkout" ${rev} WORKING_DIRECTORY ${external_lib_folder})
	endif()
endfunction()
