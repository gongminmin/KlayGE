...
STRING(FIND ${CMAKE_BINARY_DIR} "/" LAST_SLASH REVERSE)
MATH(EXPR LAST_SLASH "${LAST_SLASH} + 1")
STRING(LENGTH ${CMAKE_BINARY_DIR} DIR_LENGTH)
MATH(EXPR DIR_LENGTH "${DIR_LENGTH} - ${LAST_SLASH}")
STRING(SUBSTRING ${CMAKE_BINARY_DIR} ${LAST_SLASH} ${DIR_LENGTH} KLAYGE_BUILD_FOLDER)
