...
if(MSVC)
	...
	if(CMAKE_C_COMPILER_ID MATCHES Clang)
		...
		elseif(MSVC_VERSION GREATER_EQUAL 1910)
			...
			message(FATAL_ERROR "Unsupported compiler version. Please install vc 14.1 (VS2017) or up.")
		ENDIF()
...
ELSE()
	...
	IF(KLAYGE_COMPILER_CLANG)
		set(CMAKE_CXX_STANDARD 17)
		SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++17 -Wno-inconsistent-missing-override -Wno-missing-braces")
