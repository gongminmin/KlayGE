...
ELSE()
	...
	IF(KLAYGE_COMPILER_CLANG)
		...
		if(KLAYGE_PLATFORM_DARWIN OR KLAYGE_PLATFORM_IOS)
			if(KLAYGE_COMPILER_VERSION LESS "130")
				message(FATAL_ERROR "Unsupported compiler version. Please install Apple clang++ 13 or up.")
			endif()
		elseif(KLAYGE_PLATFORM_ANDROID)
			if(KLAYGE_COMPILER_VERSION LESS "120")
				message(FATAL_ERROR "Unsupported compiler version. Please install clang++ 12.0 (NDK 23c) or up.")
			endif()
		elseif(KLAYGE_PLATFORM_LINUX)
			if(KLAYGE_COMPILER_VERSION LESS "140")
				message(FATAL_ERROR "Unsupported compiler version. Please install clang++ 14.0 or up.")
			endif()
		endif()
	ELSE()
	...
	if(KLAYGE_COMPILER_CLANG AND (KLAYGE_COMPILER_VERSION LESS "130"))
		set(CMAKE_CXX_STANDARD 20)
		set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++20")
	else()
